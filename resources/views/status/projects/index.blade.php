...
@section('content')
    ...
    <div class="row justify-content-between align-items-center mb-2">
        ...
        <a href="{{ route('status.projects.create') }}" class="btn btn-info">Ajouter un nouveau statut</a>
    </div>
    <div class="row">
                        ...
                        <td class="">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    <form action="{{ route('status.projects.destroy', $statut) }}" method="post" class="dropdown-item" onsubmit="confirmAction(event)">
                                        @csrf
                                        @method('DELETE')
