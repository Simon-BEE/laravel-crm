...
@section('content')
    ...
    <div class="row justify-content-between align-items-center mb-2">
        ...
        <a href="{{ route('projects.create') }}" class="btn btn-info">Ajouter un nouveau projet</a>
    </div>
    <div class="row">
            ...
            <tbody>
                @foreach ($projects as $project)
                    <tr>
                        ...
                        <td>{{ $project->name }}</td>
                        <td><a href="{{ route('customers.show', $project->user) }}" class="text-secondary">{{ $project->user->name }}</a></td>
                        ...
                        <td class="">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <form action="{{ route('projects.destroy', $project) }}" method="post" class="dropdown-item" onsubmit="confirmAction(event)">
                                        @csrf
                                        @method('DELETE')
