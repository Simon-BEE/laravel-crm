                        ...
                        <td class="">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <form action="{{ route('archives.customers.restore', $user) }}" method="post" class="dropdown-item">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('archives.customers.destroy', $user) }}" method="post" class="dropdown-item" onsubmit="confirmAction(event)">
                                        @csrf
                                        @method('DELETE')
