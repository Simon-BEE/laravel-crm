...
<h2 class="mt-4">Formulaire d'édition d'un projet</h1>
    ...
    <div class="row justify-content-end">
        <div class="col-6 col-md-2">
            <form action="{{ route('projects.destroy', $project) }}" method="post" class="" onsubmit="confirmAction(event)">
                @csrf
                @method('DELETE')
    ...
    <div class="row justify-content-center">
        <form action="{{ route('projects.update', $project) }}" method="POST" class="col-md-6" role="form">
            @csrf
            @method('PATCH')
