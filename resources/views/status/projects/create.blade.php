...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('status.projects.index') }}" class="text-info">Liste des statuts de projets</a></li>
...
<div class="container">
    <form action="{{ route('status.projects.store') }}" method="post">
        @csrf
